/**
 * 중구 전체 건축물대장(표제부) 수집 스크립트
 * 실행: node scripts/etl/fetchBuildings.js
 */
...
const BASE_URL = 'http://apis.data.go.kr/1613000/BldRgstHubService/getBrTitleInfo'
...
async function main() {
  ...
  // JSON 저장
  const outPath = resolve(__dirname, '../../src/gis/data/junggu-buildings-raw.json')
